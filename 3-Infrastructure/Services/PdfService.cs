...
{
    public byte[] GenerateEmployeeResumePdf(Employee employee)
    {
        var document = new EmployeeResumeDocument(employee);
        return document.GeneratePdf();
    }

    // Private document class (kept inside the service to avoid extra folders)
    private class EmployeeResumeDocument : IDocument
    {
        ...
        public void Compose(IDocumentContainer container)
        {
            container.Page(page =>
            {
                ...
                {
                    x.Span("TalentoPlus S.A.S | Generated: ");
